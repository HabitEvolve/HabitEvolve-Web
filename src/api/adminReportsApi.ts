...
export const adminReportsApi = {
    // GET /api/admin/reports/economy?fromDate=&toDate=
    ...
    // GET /api/admin/reports/quest-completion?fromDate=&toDate=
    ...
    // GET /api/admin/reports/user-activity?fromDate=&toDate=
