      ...
      <section className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24">
        <div className="w-full max-w-md flex flex-col items-center">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-lg">{t("auth.signIn.subtitle")}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            ...
            <div className="text-center mt-4">
              <Link to="/reset-password" className="font-medium underline hover:opacity-80 text-sm" style={{ color: "#5d3b2a" }}>
          ...
          <div className="w-full flex items-center justify-center my-8">
            <span className="text-gray-500 font-medium">{t("auth.signIn.orLoginWith")}</span>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 text-sm">
              ...
              <Link to="/signup" className="font-semibold hover:underline" style={{ color: "#f27b3d" }}>
